// DO NOT MODIFY THE CODE IN THIS TAB
...
public class P_Bezier3D {
  ...
  /**
    ...
    */
  public P_Bezier3D(float[][] points, int nbrPoints) {
    degree = nbrPoints;
    makeArrays();
  ...
  /**
    ...
    */
  public P_Bezier3D(PVector[] points, int nbrPoints) {
